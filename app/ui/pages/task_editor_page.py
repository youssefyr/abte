...
class TaskEditorPage(BasePage):
    def __init__(
        ...
        self.new_btn = make_button("New task", "secondary")
        self.save_btn = make_button("Save changes", "primary")
        self.complete_btn = make_button("Mark done", "primary")
        self.delete_btn = make_button("Delete task", "danger")
